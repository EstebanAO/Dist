...
posicion_arreglo                : ID (('[' {c.add_fake_bottom()} exp {c.verify_pos_type()} ']' {c.access_array_dim_one($ID.text)}) | ('[' {c.add_fake_bottom()} exp {c.verify_pos_type()}{c.p_operators.pop()}']' '[' {c.add_fake_bottom()} exp {c.verify_pos_type()}']'{c.access_array_dim_two($ID.text)}));
